  ...
  SubmitData: function (e) {
    ...
    if (cphm.length != 5) {
      ...
      wx.request({
        ...
        data: { 'formid': formid, 'cphm': cphm, 'tel': tel, 'adr': adr, 'name': name, 'a1': a1, 'a2': a2, 'a3': a3, "sfz1": this.data.sfz1, "sfz2": this.data.sfz2, "xcz1": this.data.carCert1, "xcz2": this.data.carCert2, 'insuimg': this.data.bx, "cp": this.data.CarIndex },
        method: 'POST',
        fail: function () {
          wx.hideLoading();
          Common.ErrTips('请求失败！')
