  ...
  SubmitData: function (e) {
    ...
    if (cphm.length != 5) {
      ...
      wx.request({
        ...
        data: { 'formid': formid, 'cphm': cphm, 'tel': tel, 'address': this.data.addr, "lon": this.data.lon, lat: this.data.lat, 'name': name, 'a1': a1, 'a2': a2, 'a3': a3, "insuimg": this.data.bx, "xcz1": this.data.carCert1, "xcz2": this.data.carCert2, "cp": this.data.CarIndex },
        method: 'POST',
        fail: function () {
          wx.hideLoading();
          Common.ErrTips('请求失败！')
